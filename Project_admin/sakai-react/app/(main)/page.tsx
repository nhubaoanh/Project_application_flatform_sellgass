...
//     // useEffect(() => {
//     //     router.replace('/landing'); // ⬅️ redirect tới trang landing
//     // }, [router]);
...
export default function Home() {
    ...
    useEffect(() => {
        // const token = localStorage.getItem('Token'); // hoặc đổi theo key Bảo Anh lưu token
        // if (token) {
        //     router.replace('/dashboard'); // đã đăng nhập
        // } else {
